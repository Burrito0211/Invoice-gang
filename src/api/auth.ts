 ...
 * to protect a single self-chosen password is a worse trade than a high
 * iteration count. Format: `pbkdf2$<iterations>$<salt b64>$<hash b64>`.
 * `npm run hash-password` prints one.
 */
